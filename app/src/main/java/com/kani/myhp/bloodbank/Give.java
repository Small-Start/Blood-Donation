    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        v.findViewById(R.id.b_search_blood_banks).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    i = Class.forName("com.kani.myhp.bloodbank.Bloodbank");
        ...
        v.findViewById(R.id.b_logout).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getActivity().getSharedPreferences("firsttime", 0).edit().putInt("first",0).commit();
                Intent k = new Intent(getContext(),Firsttime.class);
                getActivity().finish();
                startActivity(k);
