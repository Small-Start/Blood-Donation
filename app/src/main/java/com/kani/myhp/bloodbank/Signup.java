...
SharedPreferences.Editor editor=sp.edit();
                ...
                if(name.equals("null")||name.equals("")||username.equals("null")||username.equals("")||password.equals("null")||password.equals(""))
                {
                    showerrorfull();
                    break;
                }
...
// Add the request to the RequestQueue.
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                pd.hide();
                                Toast.makeText(Signup.this, response + "dikkat ni h", Toast.LENGTH_LONG).show();
                                if (response.equals("User Signed Up successfully!!.")) {
                                    Class i = null;
                                    try {
    ...
    private void showerrorfull() {
        pd.hide();
        Toast.makeText(Signup.this,"Kindly Fill All The Details",Toast.LENGTH_LONG).show();
    }

    private void showerroremail() {
        pd.hide();
        Toast.makeText(Signup.this,"email incorrect",Toast.LENGTH_LONG).show();
    }
